                    ...
                    <form action="${pageContext.request.contextPath}/cadusuario" method="post" name="formulariocadastro" class="conteudo" onsubmit="return validarform(this)" >
                        <fieldset id="tabelaconteudo">
                           ...
                           <select class="tiposanguineos" name ="tiposanguineo" id="tiposanguineo" style="width: 70%; height: 30px;">
                            ...
                            <br>
                            <%-- DATANASCIMENTO--%>
                            <label for="datanascimento" class="alinhamento" >Data Nasc':</label>
                            <input type="date" name="datanascimento" id="datanascimento" style="width: 70%; height: 30px;"/>
                            <span class="style1">*</span>
                    ...
                    <form action="${pageContext.request.contextPath}/cadusuario" method="post" name="formulariocadastro" class="conteudo" onsubmit="return validarform(this)" >
                        <fieldset id="tabelaconteudo">
                           ...
                           <select class="tiposanguineos" name ="tiposanguineo" id="tiposanguineo" style="width: 70%; height: 30px;">
                            ...
                            <%-- DATANASCIMENTO--%>
                            <label for="datanascimento" class="alinhamento" >Data Nasc':</label>
                            <input type="date" name="datanascimento" value="${usuarioEditando.datanascimento}"id="datanascimento" style="width: 70%; height: 30px;"/>
                            <span class="style1">*</span>
